...
seoTitle: "Multitenancy em governo não é SaaS"
...
*Os padrões descritos emergiram de decisões de arquitetura no UniPass (Passaporte Universitário — transporte universitário municipal, produto da Requiem Company em preparação para a primeira implantação em Alagoas) e no CultBR (plataforma de gestão cultural federativa com 5.595 entes, do NEES/UFAL com o Ministério da Cultura, onde atuei como gerente de produto).*
